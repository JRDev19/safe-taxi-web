...
const columns =
    [
        ...
        { data: null, render: function (data) {
            return `
                <div>
                    <a class="btn" href="${route('roles.show', { id: data.id })}">Ver</a>
                    <a class="btn" href="${route('roles.edit', { id: data.id })}">EDIT</a>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-6 py-10">
                    ...
                    <div class="relative float-right z-10 top-[35px]">
                        <a type="button" :href="route('roles.create')"> Agregar </a>
                        <a type="button" :href="route('roles.trash')"> Eliminados </a>
