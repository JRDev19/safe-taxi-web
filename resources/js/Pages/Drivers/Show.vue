...
const status = computed(() => {
    return props.driver.is_actived ? 'Activo' : 'Inactivo';
});
...
<template>
    <Modal>
        ...
        <div class="form-group flex flex-col">  
            ...
            <div class="mt-4 mb-0">
                <label for="surnames" class="w-full">Apellidos</label>
                <InputText class="w-full" id="surnames" :placeholder="driver.surnames" disabled />
            </div>
            <div class="mt-4 mb-0">
            ...
            <div class="w-full flex items-start mt-6 justify-between">
                ...
                <Button label="Borrar" icon="pi pi-trash"
                    ...
                    @click.prevent="destroy(driver.id)" />
            </div>
        </div>
    </Modal>
</template>
